...
for value in range(0,lenpromptname):
	...
	if promptname[value] == "":
		...
		script = "# REMINDER set vim-speed to correct speed " + " "
		print (script)
		with open(out_file, 'a') as outfile:
			outfile.write("# REMINDER set vim-speed to correct speed \n")
		...
		script = "# trying to enable ssh again... "
		print(script)
		with open(out_file, 'a') as outfile:
			outfile.write("# trying to enable ssh again... \n\n")
		script = "ssh " + " "
		print (script)
		with open(out_file, 'a') as outfile:
			outfile.write("ssh " + " \n\n")
